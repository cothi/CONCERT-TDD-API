...
import { UsersRepositorySymbol } from 'src/users/infrastructure/persistence/repositories/users.repository.impl';
...
describe('UsersService', () => {
  ...
  describe('유저 생성', () => {
    it('유저를 생성하면 해당 유저를 반환한다', async () => {
      ...
      const res: UserResponseDto = await service.createUser({
        name: user.name,
        email: user.email,
      });
